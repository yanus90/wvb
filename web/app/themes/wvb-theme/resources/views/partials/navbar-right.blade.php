        ...
        {{--<div class="row mb-3">--}}
            {{--<div class="col">--}}
                {{--<ul class="list-inline contact-details">--}}
                    {{--<li class="font-weight-medium">{{ get_field('bedrijfsnaam', 'option') }}</li>--}}
                    {{--<li>{{ get_field('adres', 'option') }}</li>--}}
                    {{--<li>{{ get_field('postcode', 'option') }} {{ get_field('woonplaats', 'option') }}</li>--}}
                    {{--@if (get_field('gemeente', 'option'))--}}
                        {{--<li>Gemeente {{ get_field('gemeente', 'option') }}</li>--}}
                    {{--@endif--}}
                    {{--<li>&nbsp;</li>--}}
            ...
            {{--<div class="col">--}}
                {{--<ul class="list-inline social-links">--}}
                    {{--@if (get_field('facebook_pagina', 'option'))--}}
                        {{--<li class="list-inline-item icon"><a href="{{ get_field('facebook_pagina', 'option') }}"><i class="fab fa-twitter"></i></a></li>--}}
                    {{--@endif--}}
                    {{--@if (get_field('twitter_pagina', 'option'))--}}
                        {{--<li class="list-inline-item icon"><a href="{{ get_field('twitter_pagina', 'option') }}"><i class="fab fa-facebook-f"></i></a></li>--}}
                    {{--@endif--}}
