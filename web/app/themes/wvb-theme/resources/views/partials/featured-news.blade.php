    ...
    @foreach($latest_news_articles as $article)
        <li class="mb-3">
            <a href="{!! get_permalink($article) !!}" title="{!! $article->post_title !!}" class="media text-decoration-none">
                <img src="{!! ($article->overzichtafbeelding ? wp_get_attachment_image_url($article->overzichtafbeelding, 'thumbnail') : '//via.placeholder.com/150x150') !!}" class="mr-3 img-fluid rounded" alt="{!! $article->post_title !!}" width="70">
