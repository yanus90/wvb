                ...
                @foreach($commissions as $commission)
                    <div class="col-12 col-md-6 col-lg-4 col-xxl-3 mb-4">
                        ...
                        <a href="{!! get_term_link($commission) !!}" class="card" title="{!! $commission->name !!}">
                            <img src="{!! ($image ? wp_get_attachment_image_url($image['id'], 'commission_image') : '//via.placeholder.com/850x550?text='.$commission->name) !!}" class="card-img" alt="{!! $commission->name !!}">
