					...
					<?php foreach ( wc_get_account_orders_columns() as $column_id => $column_name ) : ?>
						<td class="woocommerce-orders-table__cell woocommerce-orders-table__cell-<?php echo esc_attr( $column_id ); ?>" data-title="<?php echo esc_attr( $column_name ); ?>">
							...
							<?php elseif ( 'order-status' === $column_id ) : ?>
                                ...
                                <span class="badge badge-pill badge-<?php echo $status_class; ?>"><?php echo esc_html( wc_get_order_status_name( $status ) ); ?></span>
							...
							<?php elseif ( 'order-actions' === $column_id ) : ?>
								...
								if ( ! empty( $actions ) ) {
									foreach ( $actions as $key => $action ) {
										echo '<a href="' . esc_url( $action['url'] ) . '" class="btn btn-sm btn-primary arrow-right no-border ' . sanitize_html_class( $key ) . '">' . esc_html( $action['name'] ) . '</a>';
									}
								}
								?>
							<?php endif; ?>
	...
	<div class="alert alert-secondary">
        <div class="row">
            ...
            <div class="col-12 col-lg-4 text-lg-right">
                <a class="btn btn-md btn-secondary no-border arrow-right" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
