...
<form class="checkout_coupon woocommerce-form-coupon" method="post" style="display:none">
    ...
    <div class="row">
        ...
        <div class="col-12">
            <button type="submit" class="btn btn-secondary no-border" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_html_e( 'Apply coupon', 'woocommerce' ); ?></button>
        </div>
    </div>
